...
def countdown(time_sec):
	try:
		while time_sec:
			...
			timeformat = '  \033[1;97m[\033[1;92m•\033[1;97m] \033[1;92mRESENDING\033[1;97m....... \033[1;92m{:02d}:{:02d}'.format(mins,secs)
			print(timeformat,end='\r')
			time.sleep(1)
			time_sec -= 1
		print (f"  {W}[{G}•{W}] {B}Start {Y}Re-Sempling ")
		time.sleep(5)
...
def tanya():
    a = input(f"  {W}[{G}•{W}] Back Tools? ({Y}y{W}/{Y}n{W}){R} :{G} ")
    if a == "y" or a == "Y":
        start()
    if a == "n" or a == "N":
...
def jam(): # Don't Remove Code !!!!
    try:
        ...
        banner()
        nomor = input(f"  {W}[{G}•{W}] {G}Enter Number {W}: {G}+62")
        while True: # Looping
            ...
            autoketik(f"  {W}[{G}✓{W}] {G}Successfully Send Spam")
...
def normal(): # Don't Remove Code !!!!
        ...
        banner()
        nomor = input(f"  {W}[{G}•{W}] {G}Enter Number {W}: {G}+62")
        jumlah = int(input(f"  {W}[{G}•{W}] Enter Spam Amount : "))
...
os.system("clear")
print (f'{R} ■ {G}𝗦𝗨𝗕𝗦𝗖𝗥𝗜𝗕𝗘 {W}𝗠𝗬 {G}𝗬𝗢𝗨𝗧𝗨𝗕𝗘')
os.system('termux-open-url https://youtube.com/channel/UCprM5VxY0pQ_i3tZO5Leaqw')
time.sleep(7)

os.system("clear")    
print (f"""{R} ■ {G}𝗝𝗢𝗜𝗡 {W}𝗠𝗬 𝗚𝗥𝗨𝗣 {G}𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣""")
...
def banner():
    ...
    autoketik (f"""
                 --oo//MMMMMMMMMMM\\oo--
               --oo//MMMMMMMMMMMMMMMMM\\oo--
            --oo//MMMMMMMMMMMMMMMMMMMMMMM\oo\--
{B}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
...
{B}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
  ...
  {W}[{R}•{W}]{G}CREATOR{W} : EXECUTOR TEAM CYBER
  {W}[{R}•{W}]{G}GITHUB{W}  : teamcyber-glitch
  {W}[{R}•{W}]{G}YOUTUBE{W} : Mr. E-Cyber Team
  {W}[{R}•{W}]{G}YOU IP{W}  : {ip}   
  
  {R}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬{W}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬{B}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬""")
def banner2():
    print (f"""{R}
  {W}[{R}1{W}]{W} Spam Brutal 
  {W}[{R}2{W}]{W} Spam Slow
  {W}[{R}3{W}]{W} Group Whatsapp
  {W}[{R}0{W}]{W} Exit
...
def start(): # Def Untuk Start Tools
    banner()
    banner2()
    pil=input(f"  {W}[{G}•{W}]{W} {G}Enter Number {W}: ")
    if pil == "1":
        jam()
    if pil == "2":
        normal()
        tanya()
    if pil == "3":
        os.system("xdg-open https://carapedi.id/hAqBHSq")
        print (f"  {W}[{R}•{W}]{W} Thank You For Using My Script,Continue Spam (y/n)")
        tanya()
    if pil == "4":
        os.system("xdg-open https://carapedi.id/b5icg")
        print (f"  {W}[{R}•{W}]{W} Thank You For Using My Script,Continue Spam (y/n)")
        tanya()        
    if pil == "0":
        print (f"  {W}[{R}•{W}]{W} Thank You For Using My Script")
        sys.exit()
